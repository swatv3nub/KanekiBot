...
from Kaneki.modules.helper_funcs.chat_status import user_admin, is_user_admin
...
from Kaneki.modules.helper_funcs.alternate import typing_action, send_action
from Kaneki.modules.sql.users_sql import get_all_chats
...
def gbanstat(update, context):
    ...
    if len(args) > 0:
        if args[0].lower() in ["on", "yes"]:
            ...
            update.effective_message.reply_text(
                "I've disabled SpamProtection in this group. GBans wont affect your users "
...
def __user_info__(user_id):
    ...
    if is_gbanned:
        ...
        if user.reason:
            ...
            text += "\n\nAppeal at @{SUPPORT_CHAT} if you think it's a Mistake !"
    else:
        text = text.format("No")
    return text
...
__help__ = """
*Admin only:*
 ✗ /spamsprotection <on/off/yes/no>: Will disable or enable the effect of Spam protection in your group.

SpamProtection uses @Spamwatch API and Global bans to remove Spammers as much as possible from your chatroom!

*What is SpamWatch?*

SpamWatch maintains a large constantly updated ban-list of spambots, trolls, bitcoin spammers and unsavoury characters.
This bot will constantly help banning spammers off from your group automatically So, you don't have to worry about spammers storming your group[.](https://telegra.ph/file/c1051d264a5b4146bd71e.jpg)
"""
...
GBAN_STATUS = CommandHandler(
    "spamprotection", gbanstat, pass_args=True, filters=Filters.group
)
